...
class CGhoulAttack_DoubleSwipe : public CAttack_Base
{
private:
    CGhoulAttack_DoubleSwipe(CGameObject* pOwner, CGameObject* pAnimOwner);
    virtual ~CGhoulAttack_DoubleSwipe() = default;
...
public:
    static CGhoulAttack_DoubleSwipe* Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime);
