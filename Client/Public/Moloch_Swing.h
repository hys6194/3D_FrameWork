...
class CMoloch_Swing : public CAttack_Base
{
private:
	CMoloch_Swing(CGameObject* pOwner, CGameObject* pAnimOwner);
	virtual ~CMoloch_Swing() = default;
...
public:
	static CMoloch_Swing*					Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime);
