...
class CMonsterState_Dead : public CMonsterState_Base
{
private:
	CMonsterState_Dead(CGameObject* pOwner, CGameObject* pAnimOwner);
	virtual ~CMonsterState_Dead() = default;
...
public:
	...
	static CMonsterState_Dead*		Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint AnimIndex);
