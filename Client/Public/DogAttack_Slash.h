...
class CDogAttack_Slash : public CAttack_Base
{
private:
    CDogAttack_Slash(CGameObject* pOwner, CGameObject* pAnimOwner);
    virtual ~CDogAttack_Slash() = default;
...
public:
    static CDogAttack_Slash* Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime);
