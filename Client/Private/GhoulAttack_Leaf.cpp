...
CGhoulAttack_Leaf::CGhoulAttack_Leaf(CGameObject* pOwner, CGameObject* pAnimOwner)
    : CAttack_Base{ pOwner, pAnimOwner }
{
}

HRESULT CGhoulAttack_Leaf::Enter_State()
{
    Setting_PlayerInfo();
    Set_CurAnimation();
...
void CGhoulAttack_Leaf::PriorityUpdate_State(_float fTimeDelta)
{
...
void CGhoulAttack_Leaf::Update_State(_float fTimeDelta)
{
...
void CGhoulAttack_Leaf::LateUpdate_State(_float fTimeDelta)
{

}

HRESULT CGhoulAttack_Leaf::Exit_State()
{
    Set_PreAnimation();
    Secede_PartCollUpdate();
...
void CGhoulAttack_Leaf::Set_PreAnimation()
{
...
void CGhoulAttack_Leaf::Update_Animation(_float fTimeDelta)
{
...
void CGhoulAttack_Leaf::Set_CurAnimation()
{
...
void CGhoulAttack_Leaf::Update_CoolTime(_float fTimeDelta)
{
    if (m_bAttack)
        return;
...
_bool CGhoulAttack_Leaf::Check_Attackable()
{
...
_bool CGhoulAttack_Leaf::Check_Colls()
{
    Setting_PlayerInfo();
...
CGhoulAttack_Leaf* CGhoulAttack_Leaf::Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime)
{
    CGhoulAttack_Leaf* pInstance = new CGhoulAttack_Leaf(pOwner, pAnimOwner);
