...
CDogAttack_GroundSlam::CDogAttack_GroundSlam(CGameObject* pOwner, CGameObject* pAnimOwner)
    : CAttack_Base{ pOwner, pAnimOwner }
{
}

HRESULT CDogAttack_GroundSlam::Enter_State()
{
    Setting_PlayerInfo();
    Set_CurAnimation();
...
void CDogAttack_GroundSlam::PriorityUpdate_State(_float fTimeDelta)
{
...
void CDogAttack_GroundSlam::Update_State(_float fTimeDelta)
{
...
void CDogAttack_GroundSlam::LateUpdate_State(_float fTimeDelta)
{

}

HRESULT CDogAttack_GroundSlam::Exit_State()
{
    Set_PreAnimation();
    Secede_PartCollUpdate();
...
void CDogAttack_GroundSlam::Set_PreAnimation()
{
...
void CDogAttack_GroundSlam::Update_Animation(_float fTimeDelta)
{
...
void CDogAttack_GroundSlam::Set_CurAnimation()
{
...
void CDogAttack_GroundSlam::Update_CoolTime(_float fTimeDelta)
{
    if (m_bAttack)
        return;
...
_bool CDogAttack_GroundSlam::Check_Attackable()
{
...
_bool CDogAttack_GroundSlam::Check_Colls()
{
    Setting_PlayerInfo();
...
CDogAttack_GroundSlam* CDogAttack_GroundSlam::Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime)
{
    CDogAttack_GroundSlam* pInstance = new CDogAttack_GroundSlam(pOwner, pAnimOwner);
...
void CDogAttack_GroundSlam::Free()
{
    __super::Free();
}
