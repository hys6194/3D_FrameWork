...
CDogAttack_3HitCombo::CDogAttack_3HitCombo(CGameObject* pOwner, CGameObject* pAnimOwner)
    : CAttack_Base{ pOwner, pAnimOwner }
{
}

HRESULT CDogAttack_3HitCombo::Enter_State()
{
    Setting_PlayerInfo();
    Set_CurAnimation();
...
void CDogAttack_3HitCombo::PriorityUpdate_State(_float fTimeDelta)
{
...
void CDogAttack_3HitCombo::Update_State(_float fTimeDelta)
{
...
void CDogAttack_3HitCombo::LateUpdate_State(_float fTimeDelta)
{

}

HRESULT CDogAttack_3HitCombo::Exit_State()
{
    Set_PreAnimation();
    Secede_PartCollUpdate();
...
void CDogAttack_3HitCombo::Set_PreAnimation()
{
...
void CDogAttack_3HitCombo::Set_CurAnimation()
{
...
void CDogAttack_3HitCombo::Update_CoolTime(_float fTimeDelta)
{
    if (m_bAttack)
        return;
...
_bool CDogAttack_3HitCombo::Check_Attackable()
{
...
_bool CDogAttack_3HitCombo::Check_Colls()
{
    Setting_PlayerInfo();
...
CDogAttack_3HitCombo* CDogAttack_3HitCombo::Create(CGameObject* pOwner, CGameObject* pAnimOwner, _uint iAnimIndex, _float fCoolTime)
{
    CDogAttack_3HitCombo* pInstance = new CDogAttack_3HitCombo(pOwner, pAnimOwner);
...
void CDogAttack_3HitCombo::Free()
{
    __super::Free();
}
